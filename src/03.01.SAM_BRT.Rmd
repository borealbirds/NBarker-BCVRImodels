...
``` {r}
pred.variables <- c("BEC_ZONE_CODE", "PROJ_AGE_1", "PROJ_HEIGHT_1", "SPECIES_CD_1", "SPECIES_CD_2", "SPECIES_PCT_1", "SPECIES_PCT_2", "BEC_SUBZONE", "CROWN_CLOSURE", "DistYear_Log", "DistYear_Nonlog")
