...
kable(stand_density_obs[1:10,c("ForID", "EstDensity", "Offset", "Rank")]) 
...
kable(testset[1:10,c("ForID", "PKEY", "EstDensity", "Exposure", "Offset", "PredxExposure", "PredByExposure", "exp.coef.fit.dens.forid_alldat_pois..")], row.names=F, digits=3) 
```
...
``` {r fit.glm.rankvsdensity, eval=T, echo=T}
